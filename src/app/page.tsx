...
function Content() {
  return (
    <main className="w-full border-b-8 border-green-200 bg-white">
      ...
      <section
        id="bg-fader"
        className="bg-gradient-to-b from-indigo-100 text-center"
      >
        <div className="container">
          <h1 className="text-4xl font-semibold leading-snug sm:text-5xl lg:text-6xl">
            Design faster by &apos;snapping&apos; website designs that inspire
            you
          </h1>

          <p className="mx-auto mt-5 max-w-xl text-lg leading-relaxed text-gray-800 sm:text-2xl">
            Use our extension to snapshot elements, entire pages, and even
            source code.
          </p>
      ...
      <section className="col container mt-8 text-center">
        ...
        <h2 id="scroll-start" className="row mb-4 text-4xl">
      ...
      <section className="mt-12">
        <div className="row justify-center space-x-5">
          <span id="scroll-1" className="text-center text-3xl">
            Select an element
          </span>
          <svg
        ...
        <div id="root-images">
          <div className="row container mx-auto mt-10 flex-wrap justify-center">
            <div className="m-3 w-full overflow-hidden sm:w-90">
              <div
                className="aspect-w-4 aspect-h-3 w-full overflow-hidden rounded-lg bg-cover bg-top"
                style={{
                  backgroundImage: "url('pandasnap/images/promo-cover.jpg')",
                }}
              ></div>
            </div>
            <div className="m-3 w-full overflow-hidden sm:w-90">
        ...
        <div className="max-w-3xl p-5">
          <div className="pointer-events-auto max-h-full rounded-lg bg-gray-200 shadow-lg">
            <div className="col mb-0 h-100 space-y-3 overflow-hidden p-5">
              <div id="root-image-form" className="w-full" data-id="fake-id">
                <div className="row w-full space-x-3">
                  <div className="h-8 flex-1 animate-pulse rounded bg-white"></div>
                  <div className="h-8 flex-1 animate-pulse rounded bg-white"></div>
                  <div className="h-8 w-20 animate-pulse rounded bg-white"></div>
                </div>
              </div>
      ...
      <section className="col container text-center">
        ...
        <div className="col space-y-5">
          ...
          <p id="scroll-reset" className="row group cursor-pointer text-xl">
            <span className="group-hover:underline">
              Play again? Go back to{" "}
            </span>
